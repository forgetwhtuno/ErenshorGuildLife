...
namespace ErenshorGuildLife
{
    ...
    internal static class SuiteUiPositionPolicy
    {
        ...
        internal static string RunSelfTests()
        {
            ...
            string uiState = SuiteUiStatePolicy.Build("guildlife", true, 522, 12.5d);
            if (uiState != "protocol=1&module=guildlife&open=true&closeable=true&sortOrder=522&activated=12.5") return "FAIL ui.state formatting";
            if (SuiteUiStatePolicy.Build("guildlife", false, 50000, double.NaN).IndexOf("sortOrder=10000&activated=0", StringComparison.Ordinal) < 0) return "FAIL ui.state bounds";
